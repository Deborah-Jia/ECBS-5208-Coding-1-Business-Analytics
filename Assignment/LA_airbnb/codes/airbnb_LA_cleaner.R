...
#location folders
dir <- "~/Desktop/ECBS-5208-Coding-1-Business-Analytics/Assignment/airbnb"
...
hw_dir <- '~/Desktop/airbnb'
data_in <- paste(hw_dir, "clean/", sep = "/") # path for saving clean data in data folder

data_out <- paste(hw_dir, "clean/", sep = "/")
output <- paste(hw_dir, "out/", sep = "/") # path for case studies (extensive folders)
...
#-------------------------------------------------------
# Import data
data <- read_csv(paste(data_in,"airbnb_LA_cleaned.csv", sep = ""))
