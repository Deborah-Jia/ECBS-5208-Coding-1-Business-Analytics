...
reg_b <- lm( lifeexp ~ ln_gdptot , data = df ) #linear model, y ~ x, tilda!
reg_b
summary( reg_b )
...
data_out <- "~/Desktop/ECBS-5208-Coding-1-Business-Analytics/C1_practice/"
htmlreg( list(reg1 , reg2 , reg3 , reg4 , reg5 , reg6 , reg7),
         ...
         file = paste0( data_out ,'model_comparison.html'), include.ci = FALSE) #confidence interval
