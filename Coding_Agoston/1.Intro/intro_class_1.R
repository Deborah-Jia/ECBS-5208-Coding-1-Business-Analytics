...
print(myString)  #so here "<-" is used to define things. we can also use "="
...
my_fav_var <- "bla"
myFavVar <- "bla"
# Do not use such things, as it's too long
...
####
# Lists can contain different elements with different characters
...
## Practice and read R for Data Science Chapter 16 OK!
